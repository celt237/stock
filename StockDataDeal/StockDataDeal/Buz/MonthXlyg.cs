...
{
    public class MonthXlyg : BuzWeekBase
    {
        public static MonthXlyg Instance = new MonthXlyg();

        public override string GetTableName(string stockCode)
        {
            return "monthxlyg_info";
        ...
        public decimal Get2(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
        ...
        public decimal Get3(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
        ...
        public decimal Get5(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
        ...
        public decimal Get8(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
        ...
        public decimal Get13(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
        ...
        public decimal Get21(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
        ...
        public decimal GetUp(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
            //上:= 五+ 2*STD(CLOSE,20);
            int n = 20;
        ...
        public decimal GetDown(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
            //下:= 五- 2*STD(CLOSE,20);
            int n = 20;
            decimal std = Formula.STD(i, "powerc", n, dtKLine);
        ...
        public decimal GetUpGui(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
            //上轨:EMA(上,3),COLOR0080FF,POINTDOT,LINETHICK2;
            return Formula.Ema(i, xlygarr[i].Dic["xlygup"], "xlygupgui", 3, xlygarr);
        }
        public decimal GetDownGui(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
            //下轨:EMA(下,3),COLOR0080FF,POINTDOT,LINETHICK2;
            return Formula.Ema(i, xlygarr[i].Dic["xlygdown"], "xlygdowngui", 3, xlygarr);
        }
        public decimal GetStock(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
        ...
        public decimal GetMoney(IList<Model.WeekStockModel> dtKLine, IList<Model.WeekStockModel> xlygarr, int i)
        {
